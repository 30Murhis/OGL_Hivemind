...
public class DialogueUI : MonoBehaviour
{
	...
	public UnityEngine.UI.Text StealthText;
	...
	public void UpdateUI()
	{
		...
		else
		{
			...
			GameObject stealthmeter = GameObject.Find("StealthMeter");
			Stealth stealthcode = stealthmeter.GetComponent<Stealth>();
			StealthText.text = stealthcode.stealthtext;
		}
	}
